# Multi-chain Mint & Burn Tracker

A Streamlit dashboard for canonical ERC-20 mint and burn activity for USDT, USAT, XAUT, and PAXG on Ethereum mainnet, plus TRC-20 USDT on Tron. It uses Etherscan and TronScan event data and classifies `Transfer` events from/to each chain's zero address.
